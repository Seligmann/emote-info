      ...
      {props.users?.length > 0 ? (
        Object.keys(props.users).map((key, i) => (
          <tr className="table-row">
            <td className="table-item"><img src={props.users[key].emote_image}></img></td>
            <td className="table-item">{props.users[key].emote}</td>
            <td className="table-item">{props.users[key].uses}</td>
